...
class WechatPayService
{
    ...
    public function handle($call_back, $pay_info)
    {
        ...
        $this->setParams($call_back, $pay_info,$request_data);
    ...
    {
        $request_data['appid'] = $pay_info['appid'];
        $request_data['mch_id'] = $pay_info['mch_id'];
        $request_data['total_fee'] = $pay_info['total_fee'];
        $request_data['body'] = $pay_info['body'];
        $request_data['attach'] = $pay_info['attach'];
        $request_data['goods_tag'] = $pay_info['goods_tag'];
        $request_data['notify_url'] = $pay_info['notify_url'];
        switch ($call_back) {
            case 'handleNative':
                $request_data['trade_type'] = 'NATIVE';
                $request_data['product_id'] = $pay_info['product_id'];
                break;
            case 'handleJsapi':
                $request_data['trade_type'] = 'JSAPI';
                $request_data['openid'] = $pay_info['openid'];
                break;
            case 'handleApp':
                break;
        }
