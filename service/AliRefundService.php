...
class AliRefundService extends CommonService
{
    ...
    public function handle($params)
    {
        ...
        $refund_request = $this->refund($params);
        $responseNode = str_replace(".", "_", $refund_request->getApiMethodName()) . "_response";
        $resultCode = $refund_request->$responseNode->code;
